                    ...
                    return ListView.separated(
                        itemBuilder: (context, index) {
                          String dateTimeString =
                              cubit.postsAllData!.content[index].created_at!;
                          ...
                          return Column(
                            children: [
                              ...
                              CreateItem(
                                  cubit: cubit,
                                  postsAllContent:
                                      cubit.postsAllData!.content[index],
                                  dateTime: dateTime,
                                  day: day,
                                  hour: hour,
                                  minute: minute,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Row(
                        children: [
                          postsAllContent.userPostInfo != null
                              ? Text(
                                  '${postsAllContent.userPostInfo!.first_name} ${postsAllContent.userPostInfo!.last_name}',
                                  style: TextStyle(
                                      decoration: TextDecoration.none,
                                      fontSize: 15.0,
                                      fontWeight: FontWeight.w600,
                      ...
                      //15:02:20
                      //2024-06-22T15:02:20
                      dateTime.month - int.parse(month) != 0
                          ? Text(
                              '${dateTime.month - int.parse(month)}mon',
                              style: TextStyle(color: Colors.grey[200]),
                            )
                          : dateTime.month - int.parse(month) == 0 &&
                                  dateTime.day - int.parse(day) != 0
                              ? Text('${dateTime.day - int.parse(day)}d',
                                  style: TextStyle(color: Colors.grey[200]))
                              : dateTime.month - int.parse(month) == 0 &&
                                      dateTime.day - int.parse(day) == 0 &&
                                      dateTime.hour - int.parse(hour) != 0
                                  ? Text('${dateTime.hour - int.parse(hour)}h',
                                      style: TextStyle(color: Colors.grey[200]))
                                  : Text(
                                      '${dateTime.minute - int.parse(minute)}min',
                                      style:
            ...
            postsAllContent.title != null &&
                    (postsAllContent.image_url == null ||
                        postsAllContent.image_url!.endsWith("media/"))
                ? Text(
                    '${postsAllContent.title}',
                    style: TextStyle(
                        height: 2.0,
                        fontSize: 17.0,
            ...
            Padding(
              padding: const EdgeInsetsDirectional.only(
                  top: 40.0, bottom: 10.0, start: 20.0, end: 20.0),
              child: Row(
                children: [
                  Icon(
